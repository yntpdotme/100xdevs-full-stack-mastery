...
const Dropdown = () => {
  return (
    <div className="bg-popover absolute top-[72px] mx-3 w-[calc(100vw-2rem)] overflow-hidden rounded-md border shadow-lg border-gray-200 dark:border-dark-800 px-1 py-3 font-light dark:shadow-[0_30px_60px_-16px] dark:shadow-primary/40">
